 ...
 *         &lt;element name="DropoffType" type="{http://fedex.com/ws/ship/v15}DropoffType"/>
 *         &lt;element name="ServiceType" type="{http://fedex.com/ws/ship/v15}ServiceType"/>
 *         &lt;element name="PackagingType" type="{http://fedex.com/ws/ship/v15}PackagingType"/>
 *         &lt;element name="ManifestDetail" type="{http://fedex.com/ws/ship/v15}ShipmentManifestDetail" minOccurs="0"/>
 *         &lt;element name="TotalWeight" type="{http://fedex.com/ws/ship/v15}Weight" minOccurs="0"/>
 *         &lt;element name="TotalInsuredValue" type="{http://fedex.com/ws/ship/v15}Money" minOccurs="0"/>
 *         &lt;element name="PreferredCurrency" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="Shipper" type="{http://fedex.com/ws/ship/v15}Party"/>
 *         &lt;element name="Recipient" type="{http://fedex.com/ws/ship/v15}Party"/>
 *         &lt;element name="RecipientLocationNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="Origin" type="{http://fedex.com/ws/ship/v15}ContactAndAddress" minOccurs="0"/>
 *         &lt;element name="SoldTo" type="{http://fedex.com/ws/ship/v15}Party" minOccurs="0"/>
 *         &lt;element name="ShippingChargesPayment" type="{http://fedex.com/ws/ship/v15}Payment" minOccurs="0"/>
 *         &lt;element name="SpecialServicesRequested" type="{http://fedex.com/ws/ship/v15}ShipmentSpecialServicesRequested" minOccurs="0"/>
 *         &lt;element name="ExpressFreightDetail" type="{http://fedex.com/ws/ship/v15}ExpressFreightDetail" minOccurs="0"/>
 *         &lt;element name="FreightShipmentDetail" type="{http://fedex.com/ws/ship/v15}FreightShipmentDetail" minOccurs="0"/>
 ...
 *         &lt;element name="CustomsClearanceDetail" type="{http://fedex.com/ws/ship/v15}CustomsClearanceDetail" minOccurs="0"/>
 *         &lt;element name="PickupDetail" type="{http://fedex.com/ws/ship/v15}PickupDetail" minOccurs="0"/>
 *         &lt;element name="SmartPostDetail" type="{http://fedex.com/ws/ship/v15}SmartPostShipmentDetail" minOccurs="0"/>
 *         &lt;element name="BlockInsightVisibility" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="LabelSpecification" type="{http://fedex.com/ws/ship/v15}LabelSpecification"/>
 *         &lt;element name="ShippingDocumentSpecification" type="{http://fedex.com/ws/ship/v15}ShippingDocumentSpecification" minOccurs="0"/>
 *         &lt;element name="RateRequestTypes" type="{http://fedex.com/ws/ship/v15}RateRequestType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="EdtRequestType" type="{http://fedex.com/ws/ship/v15}EdtRequestType" minOccurs="0"/>
 ...
 *         &lt;element name="ConfigurationData" type="{http://fedex.com/ws/ship/v15}ShipmentConfigurationData" minOccurs="0"/>
 *         &lt;element name="RequestedPackageLineItems" type="{http://fedex.com/ws/ship/v15}RequestedPackageLineItem" maxOccurs="999" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
