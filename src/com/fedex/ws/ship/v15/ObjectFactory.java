 ...
 * generated in the com.fedex.ws.ship.v15 package. 
...
public class ObjectFactory {
    ...
    private final static QName _DeleteTagRequest_QNAME = new QName("http://fedex.com/ws/ship/v15", "DeleteTagRequest");
    private final static QName _ProcessShipmentRequest_QNAME = new QName("http://fedex.com/ws/ship/v15", "ProcessShipmentRequest");
    private final static QName _ProcessTagRequest_QNAME = new QName("http://fedex.com/ws/ship/v15", "ProcessTagRequest");
    private final static QName _ShipmentReply_QNAME = new QName("http://fedex.com/ws/ship/v15", "ShipmentReply");
    private final static QName _ProcessTagReply_QNAME = new QName("http://fedex.com/ws/ship/v15", "ProcessTagReply");
    private final static QName _ProcessShipmentReply_QNAME = new QName("http://fedex.com/ws/ship/v15", "ProcessShipmentReply");
    private final static QName _DeleteShipmentRequest_QNAME = new QName("http://fedex.com/ws/ship/v15", "DeleteShipmentRequest");
    private final static QName _ValidateShipmentRequest_QNAME = new QName("http://fedex.com/ws/ship/v15", "ValidateShipmentRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fedex.ws.ship.v15
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "DeleteTagRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "ProcessShipmentRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "ProcessTagRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "ShipmentReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "ProcessTagReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "ProcessShipmentReply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "DeleteShipmentRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fedex.com/ws/ship/v15", name = "ValidateShipmentRequest")
